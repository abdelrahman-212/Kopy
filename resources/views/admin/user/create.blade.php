                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control {!! $errors->first('socond_phone', 'is-invalid') !!}" id="exampleInputSecondPhone" placeholder="Enter Second Phone" name="second_phone" value="{{ old('second_phone') ?? '' }}">
                      {!! $errors->first('socond_phone', '<p class="help-block">:message</p>') !!}
                    </div>
                  </div>
                </div>

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control"
                                                   id="title_en" placeholder="Enter Title" value="{{$gallery->title_en}}" name="title_en" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control "
                                                   id="title_ar" placeholder="Enter Title" value="{{$gallery->title_ar}}" name="title_ar" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">

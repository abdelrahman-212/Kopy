                ...
                <div class="uk-grid uk-child-width-1-2@m uk-flex-middle" data-uk-grid>
                    ...
                    <div>
                        ...
                        <div class="section-content">
                            ...
                            <div class="uk-margin-medium-top"><a class="uk-button" href="page-blog-article.html"><span>Read More</span><img class="uk-margin-small-left" src="{{asset('website-assets/img/icons/ice-cream.svg')}}" alt=""></a></div>
                        </div>
                    </div>
                </div>
            </div>

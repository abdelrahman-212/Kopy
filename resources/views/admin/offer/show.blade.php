                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $offer->buyGet->buyCategory->name_ar }} " disabled>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $offer->buyGet->getCategory->name_ar }} " disabled>
                      </div>
                    </div>
                </div>
                <div class="row">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputCategory">Category</label>
                      <input type="text" class="form-control" value="{{ $offer->details->category->name_ar }} " disabled>
                    </div>
                  </div>
                </div>
                <div class="row">

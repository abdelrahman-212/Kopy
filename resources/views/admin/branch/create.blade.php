            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {!! $errors->first('name_ar', 'is-invalid') !!}" id="exampleInputArabicName" placeholder="Enter Arabic Name" name="name_ar">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEnglishName">English Name</label>
                  <input type="text" class="form-control {!! $errors->first('name_en', 'is-invalid') !!}" id="exampleInputEnglishName" placeholder="Enter English Name" name="name_en">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control {!! $errors->first('branch_city_id', 'is-invalid') !!} branch-city-select" id="exampleInputCity" name="branch_city_id" data-target="area_id">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control {!! $errors->first('area_id', 'is-invalid') !!}" id="exampleInputArea" name="area_id">
                    <option value="">Select City</option>
                  </select>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control {!! $errors->first('address_description', 'is-invalid') !!}" id="exampleInputAddressDescription" name="address_description"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control {!! $errors->first('address_description_en', 'is-invalid') !!}" id="exampleInputAddressDescriptionEN" name="address_description_en"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {!! $errors->first('first_phone', 'is-invalid') !!}" id="exampleInputFirstPhone" placeholder="Enter First Phone" name="first_phone">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputSecondPhone">Second Phone</label>
                  <input type="text" class="form-control {!! $errors->first('second_phone', 'is-invalid') !!}" id="exampleInputSecondPhone" placeholder="Enter Second Phone" name="second_phone">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control {!! $errors->first('email', 'is-invalid') !!}" id="exampleInputEmail" placeholder="Enter Email" name="email">
                </div>
              </div>
            </div>
            <div class="row">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control {!! $errors->first('city_id', 'is-invalid') !!}" id="city-select" name="city_id">
  ...
  $( document ).ready(function() {
    ...
    $('.branch-city-select').change(e => {
        ...
        $.get(endpoint, res => {
            ...
            res.forEach(element => {
                elements += `<option value="${element.id}">${element.name_ar}</option>`;
            });

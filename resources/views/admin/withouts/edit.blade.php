                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {!! $errors->first('price', 'is-invalid') !!}" placeholder="Enter Without Price" name="price" value="{{ old('price') ?? $without->price}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {!! $errors->first('calories', 'is-invalid') !!}" placeholder="Enter Without Calories" name="calories" value="{{ old('calories') ?? $without->calories }}">

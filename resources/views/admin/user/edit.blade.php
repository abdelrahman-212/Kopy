                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input value="{{$user->age}}" type="text" class="form-control {!! $errors->first('age', 'is-invalid') !!}" id="exampleInputage" placeholder="Enter Age" name="age" value="{{ old('age') ?? '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="select2  {!! $errors->first('branches', 'is-invalid') !!}" multiple="multiple" data-placeholder="Select a branch" style="width: 100%;" name="branches[]">
                            ...
                            <option value="{{$branch->id}}" @if($user->branches->contains($branch->id)) selected @endif>{{$branch->name_en}}</option>
                            @endforeach
                          </select>

                        ...
                        <div class="first-screen__box">
                            ...
                            <div class="first-screen__breadcrumb">
                                <ul class="uk-breadcrumb">
                                    <li><a href="/">Home</a></li>
                                    <li> <a href="page-blog.html">News Blog</a></li>
            ...
            <div class="page-content">
                <div class="uk-margin-large-top uk-container uk-container-small">
                    <article class="article-full">
                        ...
                        <div class="article-full__image"><a href="/page-blog-article.html"><img src="assets/img/blog/img-article-full.jpg" alt="img-article"></a></div>
                        <div class="article-full__content">
                            ...
                            <div class="uk-grid uk-child-width-1-2@s" data-uk-grid>
                                <div><img class="uk-width-1-1" src="assets/img/blog/img-article-1.jpg" alt="article"></div>
                                <div><img class="uk-width-1-1" src="assets/img/blog/img-article-2.jpg" alt="article"></div>
                            </div>
                            ...
                            <div class="article-full__nav">
                                <ul class="articles-nav-list">
                                    <li class="articles-nav-item"><a class="articles-nav-item__link" href="#!">
                                            <div class="articles-nav-item__img"><img src="assets/img/blog/img-article-thumb-1.jpg" alt="article-thumb"></div>
                                    ...
                                    <li class="articles-nav-item"><a class="articles-nav-item__link" href="#!">
                                            <div class="articles-nav-item__img"><img src="assets/img/blog/img-article-thumb-2.jpg" alt="article-thumb"></div>
                                            <div class="articles-nav-item__info">

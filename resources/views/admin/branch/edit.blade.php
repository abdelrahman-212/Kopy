            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control {!! $errors->first('city_id', 'is-invalid') !!}" id="exampleInputCity" name="city_id">
                    @foreach($cities as $city)
                    <option value="{{$city->id}}" {{ $branch->city_id == $city->id ? 'selected' : '' }}>{{$city->name_ar}}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control {!! $errors->first('area_id', 'is-invalid') !!}" id="exampleInputArea" name="area_id">
                    @foreach ($branch->city->areas as $area)
                        <option value="{{ $area->id }}" @if($branch->area_id == $area->id) selected @endif>{{ $area->name_ar }}</option>
                    @endforeach
                  </select>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" id="city-select" name="city_id">
                                        ...
                                        @foreach ($cities as $city)
                                        <option value="{{ $city->id }}" @if($currentCity->id == $city->id) selected @endif>{{ $city->name_ar}}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                  </div>
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                <div class="icheck-primary d-inline">
                                  ...
                                  <label for="area-{{ $area->id }}">{{ $area->name_ar }}</label>
                                </div>
                              </div>
                            </div>
                            @endforeach

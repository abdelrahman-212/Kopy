                                    ...
                                    <div class="product-full-card__select">
                                        <div class="select-box select-box--thickness">
                                            <ul>
                                                ...
                                                <li><label class="mb-0"><input type="radio" name="thickness" @if($index == 0) checked @endif ><span>{{(app()->getLocale() == 'ar')? $dough->name_ar : $dough->name_en}}</span></label></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        @foreach($item['category']['extras'] as $extra)
                                            <div class="gold-members p-3 border-bottom">
                                                ...
                                                <div class="media d-flex">
                                                    <div class="mr-3"><input type="checkbox" name="" class="d-none checkExtra">

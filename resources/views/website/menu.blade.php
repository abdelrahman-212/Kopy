                                                    ...
                                                    <div class="product-item__intro">
                                                        <div class="product-item__not-active">
                                                            ...
                                                            <div class="product-item__title uk-text-truncate"><a
                                                                    href="#">{{(app()->getLocale() == 'ar')? $item->name_ar : $item->name_en}}</a>
                                                            </div>
                                                            <div
                                                    ...
                                                    <div class="product-item__info">
                                                        <div class="product-item__price">
                                                            <span>{{__('menu.Price')}}: </span><span class="value"
                                                                                                     @if($item['offer']) style="text-decoration: line-through;font-size: 20px;" @endif > {{$item->price}} </span>
                                                            @if($item['offer']) <span
                                                                style="font-size: 26px;color:#6dc405;text-decoration: none"> {{$item['offer']['offer_price']}} </span> @endif
                                                        </div>
                                                        <div class="product-item__addcart"><a @auth data-toggle="modal"
                                                                                              data-target="#service-modal"
                                                                                              @endauth class="uk-button uk-button-default cart"
                                                                                              href="{{route('item.page',[$category->id,$item->id])}}">{{__('menu.Add to Cart')}}

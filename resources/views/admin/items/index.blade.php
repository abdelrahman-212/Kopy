                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.item.edit', $item->id) }}" class="btn btn-primary btn-circle btn-sm" title="edit"><i class="fa fa-edit"></i></a>
                                <a onclick="deleteCategory('{{ 'delete-item-' . $item->id }}')" href="#" class="btn btn-danger btn-circle btn-sm" title="delete">
                                    <i class="fas fa-trash"></i>
                                </a>
                                <!-- Form Delete item -->
                                <form action="{{ route('admin.item.destroy', $item->id) }}" method="POST" id="{{ 'delete-item-' . $item->id }}">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
